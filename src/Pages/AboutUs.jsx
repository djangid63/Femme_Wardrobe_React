...
const AboutUs = () => {
  return (
    <section className='w-full h-[100%] overflow-x-hidden'>
      ...
      {/* Part 2nd */}
      <div className='w-full px-24 py-16 grid grid-cols-2 grid-rows-[1fr_0.3fr_1fr] gap-8 place-items-center'>
        {/* Grid 1 */}
        <div className='h-80 flex flex-col items-start justify-center '>
          <h1 className='font-mainHead text-6xl italic font-bold leading-tight'>From Vision to Vogue:</h1>
          <h1 className='font-mainHead text-6xl italic font-bold leading-tight'> The Birth of</h1>
          <h1 className='font-mainHead text-6xl italic font-bold leading-tight'>  FemmeWardrobe</h1>
        </div>
        <div className='h-80 flex flex-col items-start justify-center gap-3'>
        ...
        <div className='col-span-2 px-20 mt-10 flex flex-col items-start justify-center gap-3'>
          ...
          <h1 className='antialiased box-border clear-both font-mainHead text-[56px] italic font-bold leading-[64.4px] mb-[39.2px] break-words text-left capitalize'>We understand that fashion is an expression of identity, and we take pride in delivering products that embody the highest standards of quality.</h1>
